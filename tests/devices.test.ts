...
describe("Tests for VVM500&F2120-12", () => {
  ...
  test('outdoor-temperature: should be defined and configured', () => {
    ...
    expect(outdoorTemperature1.get('TemperatureSensor', 'CurrentTemperature')).toBe(8.5);
    expect(outdoorTemperature1.get('AccessoryInformation', 'Manufacturer')).toBe('Nibe');
    expect(outdoorTemperature1.get('AccessoryInformation', 'Model')).toBe(product);
    expect(outdoorTemperature1.get('AccessoryInformation', 'SerialNumber')).toBe('06603615321011');
  });  
  ...
  test('outdoor-temperature: should be defined and configured', () => {
    ...
    expect(outdoorTemperature2.get('TemperatureSensor', 'CurrentTemperature')).toBe(8.5);
    expect(outdoorTemperature2.get('AccessoryInformation', 'Manufacturer')).toBe('Nibe');
    expect(outdoorTemperature2.get('AccessoryInformation', 'Model')).toBe(product);
    expect(outdoorTemperature2.get('AccessoryInformation', 'SerialNumber')).toBe('06603615321011');
  });  
